...
Спосіб той самий, що й на an earlier build: у обидва тракти йде однаковий тест-сигнал із
кліками через рівні проміжки, кліки знаходяться в кожному каналі, пари зіставляються, і
через зсуви проводиться пряма. Нахил прямої — це дрейф.
