...
запису — суцільне **червоне** коло. Не бурштинове й не помаранчеве: у такому кольорі
іконка зливається з системним індикатором мікрофона, і стан запису стає непомітним.
Стан, який не помітно, — це стан, якого немає.
