...
|---|---|---|---|
| 1 | Розбіжність каналів за годину | < 300 мс | ✅ див. «Виміряні числа» |
...
| Тести ядра | 142, усі зелені |
| Зведення сесії 24.6 с | 0.3 МБ за 0.4 с (≈98 кбіт/с) |

Дрейф каналів на годинній базі — у [docs/notes/evidence/](docs/notes/evidence/).
