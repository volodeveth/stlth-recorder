...
/// тест-сигнал у обидва тракти і знайти зсув крос-кореляцією. На another platform це працювало,
/// бо мікрофонний тракт можна було замкнути віртуальним пристроєм. Тут такої петлі
/// немає: акустичний зв'язок «динаміки → мікрофон» вимірює ще й повітря, а
