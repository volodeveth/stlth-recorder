...
public sealed class AppSettings
{
    ...
    /// <summary>
    /// Видаляти вихідні доріжки після вдалого розпізнавання.
    ///
    /// <b>Вимкнено за замовчуванням і має таким лишатися.</b> Година розмови — це
    /// ~700 МБ у двох доріжках проти ~43 МБ зведення, тож економія справжня. Але
    /// втрата теж справжня і безповоротна: після цього єдиним джерелом лишається
    /// стиснене зведення й текст, а вихідні файли не відновити нізвідки.
    ///
    /// Спрацьовує лише тоді, коли транскрипт справді містить репліки
    /// (<see cref="Storage.SessionStore.MayRemoveAudio"/>).
    /// </summary>
    public bool DeleteAudioAfterTranscription { get; set; }
