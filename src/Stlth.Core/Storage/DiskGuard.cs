...
public static class DiskGuard
{
    ...
    /// місця відповідають лише для наявних шляхів. На another platform це привело до того, що
    /// застосунок оголосив диск повним на машині з 419 ГБ вільних — і заблокував
    /// найперший запис кожного нового користувача. Том той самий незалежно від того,
    /// чи існує листок.
    ///
