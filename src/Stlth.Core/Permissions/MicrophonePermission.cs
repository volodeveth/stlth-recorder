...
///
/// Системний звук у Windows окремого дозволу не потребує — на відміну від another platform, де
/// це другий TCC-дозвіл. Це властивість платформи, а не заслуга застосунку.
/// </summary>
