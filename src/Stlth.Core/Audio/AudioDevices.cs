...
///
/// <b>Про час.</b> У Windows немає аналога a shared-clock device, тож мікрофон і системний
/// вивід — два різні пристрої з двома різними годинниками. Спільною опорою для них
