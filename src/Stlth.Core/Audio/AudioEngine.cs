...
///
/// <b>Головне рішення тут одне.</b> У Windows немає a shared-clock device, тож мікрофон і
/// системний вивід не можуть ділити годинник. Спільною опорою служить QPC: кожен
